...
class _$CountriesRecord extends CountriesRecord {
  ...
  _$CountriesRecord._({this.name, this.img, this.ffRef}) : super._();
  ...
  @override
  int get hashCode {
    return $jf($jc($jc($jc(0, name.hashCode), img.hashCode), ffRef.hashCode));
  }
...
class CountriesRecordBuilder
  ...
  _$CountriesRecord _build() {
    final _$result =
        _$v ?? new _$CountriesRecord._(name: name, img: img, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
