...
class AppStateNotifier extends ChangeNotifier {
  HotelBookingAppFirebaseUser? initialUser;
  HotelBookingAppFirebaseUser? user;
  ...
  void update(HotelBookingAppFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? MyTripsWidget() : LoginPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => ConfirmBookingWidget(
            ...
            ratings: params.getParam('ratings', ParamType.String),
